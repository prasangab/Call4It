 ...
 */
public class AccidentCover_Activity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.accidentcover_layout);
        init();
    }
    ...
    public void onClick(View v) {
        if (v==back){
            startActivity(new Intent(AccidentCover_Activity.this, Main_Activity.class));
            AccidentCover_Activity.this.finish();
        }else if (v==done){
    ...
    public void init(){
        ...
        back.setOnClickListener(AccidentCover_Activity.this);
        done.setOnClickListener(AccidentCover_Activity.this);
