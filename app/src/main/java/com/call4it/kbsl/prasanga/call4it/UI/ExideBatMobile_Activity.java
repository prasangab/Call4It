 ...
 */
public class ExideBatMobile_Activity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exidebatmobile_layout);
        init();
    }
    ...
    public void onClick(View v) {
        if (v==back){
            startActivity(new Intent(ExideBatMobile_Activity.this, Main_Activity.class));
            ExideBatMobile_Activity.this.finish();
        }else if (v==done){
    ...
    public void init(){
        ...
        back.setOnClickListener(ExideBatMobile_Activity.this);
        done.setOnClickListener(ExideBatMobile_Activity.this);
